  ...
  return (
    <>
      ...
      <form id="contactForm" onSubmit={(event) => submitForm(event)}>
        Name<br /> 
        <input placeholder="Your Name" name="Name" type="text" autoComplete="name" required /><span className="requiredField"> *</span><br /><br />
        Email Address<br />
        <input placeholder="Your Email" name="Email" type="email" autoComplete="email" required /><span className="requiredField"> *</span><br /><br />
        {/* rows="5" cols="30" */}
        Your Message<br />
        <textarea name="Message"  placeholder="Your message here..." required /><span className="requiredField"> *</span><br /><br /><br />
        <button type="submit">
