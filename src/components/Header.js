  ...
  return (
    <>
      <div id="navBar">
        ...
        <img id="navBarPhotoNameWordArt" src={nameWordArt} alt="Aaron Mejia name" />
        <img id="navBarPhotoProfilePic" src={profilePic} alt="Silhouette of Aaron sitting on beach watching sunset" />
        <Modal
          isOpen={modalDisplay}
